...
(() => {
  ...
  const stylesheet =
    ...
    ':host([compact]) .empty{gap:3px;padding:6px}' +
    ':host([compact]) .empty .sub{display:none}' +
    ':host([compact]) .empty .cap{font-size:10px;line-height:1.15}' +
    ':host([compact]) .empty svg{width:14px;height:14px}' +
