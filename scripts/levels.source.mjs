...
water     | fall:a, melon:a, proof:a      | element    | free
...
foot      | ball:a, print:a, step:a       | body       | free
rain      | bow:a, coat:a, drop:a         | weather    | free
star      | fish:a, light:a, dust:a       | sky        | free
bird      | cage:a, song:a, bath:a        | animals    | free
...
key       | board:a, hole:a, chain:a        | things     | free
head      | ache:a, light:a, phone:a        | body       | free
...
eye       | ball:a, brow:a, lash:a        | body       | free
air       | port:a, plane:a, line:a         | element    | free
